...
interface CreateProfile_PersonalInfoFormProps {
  name: string;
  email: string;
  phone: string;
  location: string;
...
const CreateProfile_PersonalInfoForm: React.FC<CreateProfile_PersonalInfoFormProps> = ({
  name,
  email,
  phone,
  location,
...
export default CreateProfile_PersonalInfoForm;
