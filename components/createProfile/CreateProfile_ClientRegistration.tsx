...
interface CreateProfile_ClientRegistrationProps {
...
const CreateProfile_ClientRegistration: React.FC<CreateProfile_ClientRegistrationProps> = ({ onComplete, onBack }) => {
...
export default CreateProfile_ClientRegistration;
